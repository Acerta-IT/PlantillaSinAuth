...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-justify-center dz-bg-transparent dz-dark:border-gray-600 dz-dark:hover:border-gray-500">
        ...
        <div @click="$refs.input.click()" class="dz-border dz-border-dashed dz-rounded dz-border-gray-500 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging" class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-3 py-4 dz-h-full dz-dark:bg-gray-700">
                    ...
                    <p class="dz-text-sm dz-md:text-base dz-text-gray-600 dz-dark:text-gray-400">Arrastra y suelta o <span class="dz-font-semibold dz-text-black dz-dark:text-white">Usa el explorador</span></p>
                </div>
                <div x-show="isDragging" class="dz-flex dz-items-center dz-bg-gray-100 dz-dark:bg-gray-800 dz-justify-center dz-gap-3 py-4 dz-h-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="dz-w-4 dz-h-4 dz-md:w-6 dz-md:h-6 dz-text-gray-500 dz-dark:text-gray-400">
                    ...
                    <p class="dz-text-sm dz-md:text-base dz-text-gray-600 dz-dark:text-gray-400">Suéltalo aquí</p>
                </div>
            </div>
            <input
                    x-ref="input"
        ...
        <div class="dz-flex dz-justify-between dz-w-full dz-mt-2">
            ...
            <div x-show="isLoading" class="dz-flex dz-gap-1 dz-items-center">
                ...
                <div @click="cancelUpload" class="dz-text-xs dz-md:text-sm dz-text-gray-800 dz-dark:text-gray-200 dz-hover:cursor-pointer dz-underline">Cancelar subida</div>
            </div>
        </div>
